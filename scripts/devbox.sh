...
RN_API_NAMESPACE=$IOS_RN_REQUIRED_API_NAMESPACE
...
iOS App     : RN_WEB_APP_BASE_URL=$DEVBOX_SITE_URL | RN_DEFAULT_WS_URL=$DEVBOX_RN_WS_URL | RN_API_NAMESPACE=$IOS_RN_REQUIRED_API_NAMESPACE
