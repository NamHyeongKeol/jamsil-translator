          ...
          {isLimitReached && !isActive && (
            <div className="flex flex-col items-center justify-center text-center text-gray-400 gap-2 pt-4">
              <div className="bg-amber-50 border border-amber-200 rounded-xl px-4 py-3 text-center">
                <p className="text-xs font-semibold text-amber-600 mb-1">Usage limit reached</p>
                <p className="text-[10px] text-amber-500/80">Please try again in a new session.</p>
              </div>
            </div>
          )}
